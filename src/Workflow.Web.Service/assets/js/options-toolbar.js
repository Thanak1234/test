...
(function() {
    ...
    var scriptTags = document.getElementsByTagName('script'),
        ...
        defaultQueryString, src, env, rtl, toolbar;
    ...
    while (i--) {
        ...
        if (src.indexOf('include-ext.js') !== -1) {
            ...
            if (defaultQueryString) {
                defaultEnv = getQueryParam('env', defaultQueryString) || defaultEnv;
    ...
    Ext.themeName = env = getQueryParam('env') || defaultEnv;
    ...
    Ext.onReady(function() {
        Ext.getBody().addCls(Ext.baseCSSPrefix + 'env-' + Ext.envName);
        ...
        setTimeout(function() {
			toolbar = Ext.widget({
                ...
                items: [{
                    xtype: 'combo',
                    width: comboWidth[Ext.envName],
                    labelWidth: labelWidth[Ext.envName],
