...
(function() {
	...
	var scriptEls = document.getElementsByTagName('script'),
        ...
        themeName = getQueryParam('profile') || 'classic',
	...
	//extDir = (extDir + '/ext/build'); // custom by append '/ext' as Ext directory.
	extDir = 'http://10.60.0.113/workflow/ext/build';
	//extPackagesRoot = devMode ? (extDir + '/build') : extDir;
	extPackagesRoot = devMode ? extDir : extDir;
