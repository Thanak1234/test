...
{
    [RoutePrefix("api/n2mwoprocessinstant")]
    public class N2MWOProcessInstantController : ReportController<N2MWOProcInst, ProcInstMWOParam>
    {
        [HttpGet]
        ...
        public HttpResponseMessage Export()
        {
            ...
            return ExportFile(buffer, "N2MWO_PROCESS_INSTANCE");
        }
    }
}