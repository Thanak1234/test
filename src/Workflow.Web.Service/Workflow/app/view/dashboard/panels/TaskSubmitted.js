Ext.define("Workflow.view.dashboard.panels.TaskSubmitted", {
    extend: "Ext.grid.Panel",
    xtype: 'dashboard-tasksubmitted',
    controller: "dashboard-tasksubmitted",
    viewModel: {
        type: "dashboard-tasksubmitted"
    },
    ...
    initComponent: function () {
        ...
        var store = Ext.create('Workflow.store.dashboard.Tasks', {
            proxy: {
                type: 'rest',
                url: Workflow.global.Config.baseUrl + 'api/dashboard/tasks/submitted',
                reader: {
                    type: 'json',
    ...
    initColumns: function() {
        ...
        me.columns = [
            ...
            { text: "FORM NAME", sortable: true, menuDisabled: true, dataIndex: 'appName', flex:1 , renderer: highlight },
            {
            ...
            { text: "LAST ACTIVITY", sortable: true, menuDisabled: true, dataIndex: 'lastActivity', flex:1 , renderer: highlight },
