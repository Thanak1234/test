 ...
 * logged out.
 */
Ext.define('Ng.widgets.SessionMonitor', {
    singleton: true,
    ...
    window: Ext.create('Ext.window.Window', {
        ...
        buttons: [{
            ...
            handler: function () {
                Ext.TaskManager.stop(Ng.widgets.SessionMonitor.countDownTask);
                Ng.widgets.SessionMonitor.window.hide();
                Ng.widgets.SessionMonitor.start();
