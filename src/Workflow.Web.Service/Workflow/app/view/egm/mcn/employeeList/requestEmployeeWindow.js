Ext.define("Workflow.view.mcn.employeeList.requestEmployeeWindow", {
    extend: "Workflow.view.common.requestor.AbstractWindowDialog",

    requires: [
        "Workflow.view.mcn.employeeList.requestEmployeeWindowController",
        "Workflow.view.mcn.employeeList.requestEmployeeWindowModel"
    ],

    controller: "mcn-employeelist-requestemployeewindow",
    viewModel: {
        type: "mcn.employeelist-requestemployeewindow"
    },
    height: 500,
