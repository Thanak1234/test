Ext.define('Workflow.view.icd.employeeList.requestEmployeeController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.icd-employeelist-requestemployee',
    ...
    showWindowDialog: function (lauchFromel, model, title, cb) {
        ...
        var me = this;
        var window = Ext.create('Workflow.view.icd.employeeList.requestEmployeeWindow',
         {
             title: title,
             mainView: me,
             viewModel: {
