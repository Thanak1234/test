Ext.define("Workflow.view.icd.employeeList.requestEmployeeWindow", {
    extend: "Workflow.view.common.requestor.AbstractWindowDialog",

    requires: [
        "Workflow.view.icd.employeeList.requestEmployeeWindowController",
        "Workflow.view.icd.employeeList.requestEmployeeWindowModel"
    ],

    controller: "icd-employeelist-requestemployeewindow",
    viewModel: {
        type: "icd.employeelist-requestemployeewindow"
    },
    height: 500,
