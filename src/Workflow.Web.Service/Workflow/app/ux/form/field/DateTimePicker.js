...
Ext.define('Workflow.ux.form.field.DateTimePicker', {
...
Ext.define('Workflow.ux.form.field.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.datetime',
    alwaysOnTop: true,
    requires: ['Workflow.ux.form.field.DateTimePicker'],
    ...
    createPicker: function() {
        ...
        return Ext.create('Workflow.ux.form.field.DateTimePicker', Ext.merge(initialConfig, parentConfig));
    },
