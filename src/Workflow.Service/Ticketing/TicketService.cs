...
namespace Workflow.Service.Ticketing
{
    public class TicketService : ITicketService
    {
        ...
        private readonly ITicketSlaMappingRepository slaMappingRepo;
        ...
        public IEnumerable<TicketSlaMappingDto> getSlasMapping(string query = null)
        {
            try
            {
                return slaMappingRepo.getSlasMapping(query);
            }
            catch (Exception e)
            {
                Console.WriteLine(e.StackTrace);
        ...
        {
            return slaMappingRepo.isSlaMappingExisted(instance);
        }

        public TicketSLAMapping addNewSlaMapping(TicketSLAMapping instance)
        {
            try
            {
                slaMappingRepo.Add(instance);
                return instance;
            }
            catch (Exception e)
            {
        ...
        public TicketSLAMapping updateSlaMapping(TicketSLAMapping instance)
        {
            try
            {
                slaMappingRepo.Update(instance);
                return instance;
            }
            catch (Exception e)
            {
