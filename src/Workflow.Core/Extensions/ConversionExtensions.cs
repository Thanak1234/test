...
using Workflow.Enterprise.Core.ComponentModel;
...
namespace Workflow
{
    ...
    public static class ConversionExtensions
    {
        ...
        public static T TypeAs<T>(this object o)
        {
            T res;
        ...
        public static bool In(this int type, params int[] numbers)
        {
        ...
        public static bool InAny(this int type, params int[] numbers)
        {
            foreach (var number in numbers)
            {
                if (type == number)
