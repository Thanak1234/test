...
namespace Workflow
{
    ...
    public static class StringExtensions
    {
        ...
        private const string Domain = @"NAGAWORLD\";

        private delegate void ActionLine(TextWriter textWriter, string line);

        public static string FQNWithoutK2Label(this string str) {
            if (string.IsNullOrEmpty(str))
            {
                return string.Empty;
            }
            else {
                return str.Replace("K2:", string.Empty);
            }
        }

        public static string FQNWithK2Label(this string str)
        {
            ...
            if (string.IsNullOrEmpty(str))
            {
                ...
                {
                    return string.Format("{0}{1}{2}", "K2:", Domain, str);
                }
                else {
                    return string.Format("{0}{1}", "K2:", str);
                }
            }
        }

        public static int ToProcInstId(this string serialNo)
        {
            ...
            {
                return Convert.ToInt16(serialNo.Split('_')[0]);
            }
        }

        public static int ToActDestInstId(this string serialNo)
        {
            if (string.IsNullOrEmpty(serialNo))
            {
                return 0;
            ...
            {
                return Convert.ToInt16(serialNo.Split('_')[1]);
            }
        }
        ...
        /// <summary>
        /// Replaces pascal casing with spaces. For example "UserId" would become "User Id".
        ...
        public static string CapitalLetter(this string s)
        {
            if (String.IsNullOrEmpty(s))
                return s;

            string str = s.Replace("_", " ").ToLower();
            if (str.Length == 1)
                return str.ToUpper();

            str = Thread.CurrentThread.CurrentCulture.TextInfo.ToTitleCase(str);
            return str.Replace(" Of ", " of ");
        }
