...
namespace Workflow
{
    ...
    public static class DateTimeExtensions
    {
        ...
        /// <summary>For dateTime smaller than on 1st January 1990 return null instance.</summary>
        public static DateTime? Nullable(this DateTime? dateTime)
        {
            return dateTime > new DateTime(1990, 01, 01) ? dateTime : null;
        }
    }
}
