...
namespace Workflow.DataAcess.Repositories.N2MWO
{
    ...
    public class N2RequestInformationRepository : RepositoryBase<N2RequestInformation>, IN2RequestInformationRepository
    {
        public N2RequestInformationRepository(IDbFactory dbFactory) : base(dbFactory) { }
