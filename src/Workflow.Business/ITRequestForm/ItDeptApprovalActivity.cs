...
{
    public class ItDeptApprovalActivity : AbstractActivity<IItFormDataProcessing>, IActivity<IItFormDataProcessing>
    {

        private IItFormDataProcessing _itFormDataProcessing = null;
        public ItDeptApprovalActivity() : base(ItRequestFormBC.IT_APPROVAL) {
