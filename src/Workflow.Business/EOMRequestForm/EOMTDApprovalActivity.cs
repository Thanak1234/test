...
namespace Workflow.Business.EOMRequestForm {
    public class EOMTDApprovalActivity : AbstractActivity<IEOMFormDataProcessing>, IActivity<IEOMFormDataProcessing>
    {

        private IEOMFormDataProcessing _EOMFormDataProcessing = null;

        public EOMTDApprovalActivity() : base(EOMRequestFormBC.TD_APPROVAL) {
