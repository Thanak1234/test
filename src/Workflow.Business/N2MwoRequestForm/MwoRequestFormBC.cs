...
namespace Workflow.Business.N2MwoRequestForm
{
    public class N2MwoRequestFormBC : AbstractRequestFormBC<N2MwoRequestWorkflowInstance, IDataProcessing>, IN2MwoRequestFormBC
    {

        private IN2InformationRepository informationRepo;
        private N2DepartmentChargableRepository departmentRepo;
