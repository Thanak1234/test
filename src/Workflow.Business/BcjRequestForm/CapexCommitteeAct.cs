...
{
    public class CapexCommitteeAct : AbstractActivity<IBcjFormDataProcessing>, IActivity<IBcjFormDataProcessing>
    {
        private IBcjFormDataProcessing _bcjFormDataProcessing = null;

        public CapexCommitteeAct() : base(BcjRequestFormBC.CapexCommittee)
        {
