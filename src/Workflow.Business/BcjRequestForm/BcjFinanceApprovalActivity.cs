...
{
    public class BcjFinanceApprovalActivity : AbstractActivity<IBcjFormDataProcessing>, IActivity<IBcjFormDataProcessing>
    {
        private IBcjFormDataProcessing _bcjFormDataProcessing = null;

        public BcjFinanceApprovalActivity() : base(BcjRequestFormBC.Finance_Group)
        {
